...
dev.off()
# Plot PCA plot
png('PCA_plot_for_samples.png',width = 1000,height = 750,units = 'px',res = 150)
dba.plotPCA(ATAC_peakset,attributes = DBA_TREATMENT,label = DBA_ID,labelSize = 0)
dev.off()
# Normalize 
...
ATAC_dds <- ATAC_peakset$DESeq2$DEdata
png('DESeq2_dispersion_plot.png',width = 1000,height = 700,units = 'px',res = 150)
DESeq2::plotDispEsts(ATAC_dds,cex.lab = 1.5,
...
write.csv(diffbind_integrated,'diffbind_integrated.csv',row.names = FALSE)
